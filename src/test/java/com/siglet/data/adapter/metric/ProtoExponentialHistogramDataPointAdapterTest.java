...
class ProtoExponentialHistogramDataPointAdapterTest {
    ...
    public void getUpdated_onlyExemplarsUpdated() {
        ...
        assertEquals(ByteString.copyFrom(AdapterUtils.spanId(60)),actualExemplars.get(0).getSpanId());
        assertEquals(ByteString.copyFrom(AdapterUtils.traceId(70,80)),actualExemplars.get(0).getTraceId());
        assertEquals(90,actualExemplars.get(0).getAsInt());
        assertEquals(100,actualExemplars.get(0).getTimeUnixNano());


        assertEquals(ByteString.copyFrom(AdapterUtils.spanId(600)),actualExemplars.get(1).getSpanId());
        assertEquals(ByteString.copyFrom(AdapterUtils.traceId(700,800)),actualExemplars.get(1).getTraceId());

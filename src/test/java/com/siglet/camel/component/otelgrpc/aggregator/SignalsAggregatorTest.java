...
class SignalsAggregatorTest {
    ...
    void add_metric_sameResource_sameInstrumentation() {
        ...
        protoMetricAdapter2 = new ProtoMetricAdapter(metric2, resource1, instrumentationScope1, true);
    ...
    void add_metric_sameResource_twoInstrumentation() {
        ...
        protoMetricAdapter2 = new ProtoMetricAdapter(metric2, resource1, instrumentationScope2, true);

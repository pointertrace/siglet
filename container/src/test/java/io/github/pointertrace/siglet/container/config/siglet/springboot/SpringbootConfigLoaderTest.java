...
class SpringbootConfigLoaderTest {
    ...
    void load() throws IOException {
        ...
        SigletBundle sigletBundle = springBootBundleLoader.load(sigletSpringBootFile);
        ...
        assertEquals("io.github.pointertrace.siglet.example.springboot.suffix.siglet.SuffixSpanlet",
                sigletDefinition.getSigletConfig().sigletClassName());
        assertEquals("io.github.pointertrace.siglet.example.springboot.suffix.parser.SuffixConfigChecker",

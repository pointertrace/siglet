        ...
        return ConfigurationFactory.of(
                List.of(
                        ...
                        optionalProperty("batch-size-in-signals", OtelGrpcExporterConfig::setBatchSizeInSignals,
                                integerValueObject().customErrorMessage("#location Batch size must be an integer")).customErrorMessage("Invalid batch size at #location:",""),
                        optionalProperty("batch-timeout-in-millis", OtelGrpcExporterConfig::setBatchTimeoutInMillis,
                                integerValueObject().customErrorMessage("#location Batch timeout must be an integer")).customErrorMessage("Invalid batch timeout at #location:",""),
                        optionalProperty("queue-size", OtelGrpcExporterConfig::setQueueSize, integerValueObject().customErrorMessage("#location Queue size must be an integer")).customErrorMessage("Invalid queue size at #location:","")),

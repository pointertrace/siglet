...
import io.github.pointertrace.siglet.impl.engine.pipeline.processor.siglet.groovy.proxy.NumberDataPointAttributesProxy;
import io.github.pointertrace.siglet.impl.engine.pipeline.processor.siglet.groovy.proxy.SpanAttributesProxy;
...
class AttributesGroovyTest {
    ...
    void metricAttributes() {
        ...
        Script script = compiler.compile(attributesScript);
        // todo acertar o null
        compiler.prepareScript(script, metricAdapter, null);
        script.run();

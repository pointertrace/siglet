    ...
    void getValue() {
        ...
        String config = """
                global:
                  queue-size: 1
                  thread-pool-size: 2
                  internal-metrics-export-interval-millis: 3
                receivers:
                - grpc: first-receiver
                  config:
        ...
        assertEquals(3, globalConfig.getInternalMetricsExportIntervalMillis().getValue().intValue());
        assertEquals(Location.of(4, 44), globalConfig.getInternalMetricsExportIntervalMillis().getLocation());
        ...
        assertEquals(Location.of(6, 3), firstReceiver.getType().getLocation());
        assertEquals("first-receiver", firstReceiver.getName().getValue());
        assertEquals(Location.of(6, 9), firstReceiver.getName().getLocation());
        assertEquals(Location.of(6, 3), firstReceiver.getLocation());
        ...
        assertEquals(Location.of(8, 14), firstReceiverConfig.getAddress().getLocation());

        ReceiverDescriptor secondReceiver = yamlDescriptor.getReceivers().get(1);
        assertEquals("grpc", secondReceiver.getType().getValue());
        assertEquals(Location.of(9, 3), secondReceiver.getType().getLocation());
        assertEquals("second-receiver", secondReceiver.getName().getValue());
        assertEquals(Location.of(9, 9), secondReceiver.getName().getLocation());
        assertEquals(Location.of(9, 3), secondReceiver.getLocation());
        ...
        assertEquals(Location.of(11, 14), secondReceiverConfig.getAddress().getLocation());
        ...
        assertEquals(Location.of(13, 3), firstExporter.getType().getLocation());
        assertEquals("first-exporter", firstExporter.getName().getValue());
        assertEquals(Location.of(13, 9), firstExporter.getName().getLocation());
        assertEquals(Location.of(13, 3), firstExporter.getLocation());
        ...
        assertEquals(Location.of(15, 14), firstExporterConfig.getAddress().getLocation());

        ExporterDescriptor secondExporter = yamlDescriptor.getExporters().get(1);
        assertEquals("grpc", secondExporter.getType().getValue());
        assertEquals(Location.of(16, 3), secondExporter.getType().getLocation());
        assertEquals("second-exporter", secondExporter.getName().getValue());
        assertEquals(Location.of(16, 9), secondExporter.getName().getLocation());
        assertEquals(Location.of(16, 3), secondExporter.getLocation());
